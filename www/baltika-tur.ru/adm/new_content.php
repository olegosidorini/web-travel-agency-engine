...
$dbh->query("INSERT INTO ve_contents(type,name,status) values('obr','Новый объект размещения','1')");
$pid=$dbh->query("SELECT * FROM ve_contents WHERE type='obr' ORDER BY id DESC")->fetch(PDO::FETCH_ASSOC)['id'];
